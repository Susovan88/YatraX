...
const TicketsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F1F1] flex flex-col items-center py-8 px-6 relative overflow-hidden">
      {/* Background Splash */}
      <div
      ...
      {/* <div className="absolute left-4 top-8 z-20 flex flex-col items-start sm:static sm:flex-row sm:items-center sm:gap-3 w-auto">
        <button
          onClick={() => navigate(-1)}
          className="bg-[#907EFF] text-white rounded-lg p-2 font-semibold hover:bg-[#7a6ad6] transition flex items-center justify-center sm:mb-0"
          aria-label="Back"
      ...
      <div className="w-full max-w-screen-md mx-auto z-10 relative sm:pt-0">
